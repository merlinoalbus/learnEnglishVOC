          ...
          <CardContent className="p-6 h-full flex flex-col">
            ...
            <div className="flex-1 grid grid-cols-3 gap-8 h-full max-h-full overflow-hidden">
              ...
              <div className="flex flex-col">
                ...
                <div className="bg-gradient-to-br from-white/70 to-gray-50/70 dark:from-gray-800/70 dark:to-gray-900/70 backdrop-blur-sm rounded-2xl p-5 border border-white/30 dark:border-gray-700/30 shadow-lg h-full flex flex-col max-h-full">
